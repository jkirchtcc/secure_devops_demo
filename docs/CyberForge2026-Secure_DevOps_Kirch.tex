...
\begin{itemize}
  \item After install, \texttt{\textasciitilde/.local/bin} is added to \texttt{PATH}
  \item But you need to \textbf{logout and log back in} for the change to take effect
\end{itemize}
\end{frame}
