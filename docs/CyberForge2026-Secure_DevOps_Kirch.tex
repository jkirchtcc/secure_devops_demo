...
ssh-keygen -t ed25519 -C DemoSSHKey \
  -f /home/ansible_user/.ssh/DemoSSHKey -N ""
\end{codebash}
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textbf{\texttt{-N ""}}: Empty passphrase (demo only --- use a real one in production!)
  \end{itemize}
  \item After running this command, you'll have two files:
  \begin{itemize}
    \item \textasciitilde/.ssh/DemoSSHKey (the private key)
    \item \textasciitilde/.ssh/DemoSSHKey.pub (the corresponding public key)
  \end{itemize}
\end{itemize}
\end{frame}
